...
class YOLODetector:
    ...
    def from_path(
        ...
        config = DetectorConfig(
            model_path=model_path, device=device, vehicle_classes=vehicle_classes
        )
        return cls(config)
    ...
    def reset_tracking(self) -> None:
        ...
        # YOLO automáticamente reinicia el tracking cuando detecta un nuevo video
        # No es necesario recargar el modelo completo desde disco
        pass
